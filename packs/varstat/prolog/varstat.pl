...
% vt_sum(+List, -Sum): Sum is the integer total of all values in List.
% Delegates to sum_list/2 from library(lists).
vt_sum(List, Sum) :-
% sum_list is the standard SWI-Prolog predicate for totaling a list of numbers.
    sum_list(List, Sum).

% vt_mean_floor(+List, -Mean): Mean is the floor of the arithmetic mean of List.
...
% vt_mean_round(+List, -Mean): Mean is the rounded arithmetic mean of List.
...
% vt_deviation(+List, -Devs): Devs[I] = List[I] - floor_mean(List) for each I.
...
% vt_abs_deviation(+List, -AbsDevs): AbsDevs[I] = |List[I] - floor_mean(List)|.
...
% vt_row_sums(+Grid, -Sums): Sums[R] is the integer sum of all values in row R.
...
% vt_col_sums(+Grid, -Sums): Sums[C] is the integer sum of all values in column C.
...
% vt_row_means(+Grid, -Means): Means[R] is the floor mean of row R.
% Each mean is computed independently by vt_mean_floor.
...
% vt_col_means(+Grid, -Means): Means[C] is the floor mean of column C.
...
% vt_global_mean(+Grid, -Mean): Mean is the floor mean of all cell values in Grid.
...
% vt_above_mean(+Grid, -Cells): Cells is the sorted R-C list of positions
...
% vt_below_mean(+Grid, -Cells): Cells is the sorted R-C list of positions
...
% vt_row_above_mean(+Grid, -Cells): Cells is the sorted R-C list of positions
...
% vt_col_above_mean(+Grid, -Cells): Cells is the sorted R-C list of positions
