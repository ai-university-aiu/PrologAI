...
test(count4_blob) :-
    grid_blob(G),
    connect_count4(G, 1, N), N =:= 2.

test(count4_none) :-
    grid_isolated(G),
    connect_count4(G, 9, N), N =:= 0.
...
test(count8_diagonal) :-
    grid_diagonal(G),
    connect_count8(G, 1, N), N =:= 1.

test(count8_none) :-
    grid_diagonal(G),
    connect_count8(G, 9, N), N =:= 0.
...
test(smallest4_blob) :-
    ...
    grid_blob(G),
    connect_smallest4(G, 1, Smallest),
...
test(border_cells_ring) :-
    ...
    grid_ring(G),
    connect_components4(G, 1, [Ring]),
    connect_border_cells(G, Ring, Border),
    length(Border, N), N =:= 8.
...
test(border_cells_solid5) :-
    ...
    connect_border_cells(G, All, Border),
...
test(interior_cells_solid5) :-
    ...
    grid_solid5(G),
    connect_components4(G, 1, [All]),
    connect_interior_cells(G, All, Interior),
...
test(interior_cells_ring) :-
    ...
    grid_ring(G),
    connect_components4(G, 1, [Ring]),
    connect_interior_cells(G, Ring, Interior),
    Interior = [].
