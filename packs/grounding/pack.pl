% State the fact: this pack is named grounding.
name(grounding).
% State the fact: this is version 1.0.0.
version('1.0.0').
% State the fact: the title carries the work-package number.
title('PrologAI Causalontology Clue Grounding — turn a human natural-language clue and a referent into Causalontology assertions (continuant, disposition, goal, or preventive), the grounding seam of Causalontology_v5 Section 10 (WP-417)').
