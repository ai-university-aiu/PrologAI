% State the fact: name(lattice).
name(lattice).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Lattice — Persistent Shared Memory Network (PRs 3-5, 15)').
title('PrologAI Lattice — Persistent Shared Memory Network (PRs 3-5, 15)').
