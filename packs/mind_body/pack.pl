% State the fact: name(mind_body).
name(mind_body).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Mind-Body Interface — herald protocol, body enrollment, percept relay, command dispatch (PR 10)').
title('PrologAI Mind-Body Interface — herald protocol, body enrollment, percept relay, command dispatch (PR 10)').
