...
% g3x4_hstripe: colors are [r,b,g].
    g3x4_hstripe(G),
    gridrun_stripe_colors_h(G, Colors),
    Colors = [r,b,g].
...
% g4x3_vstripe: col colors [r,b,g].
    g4x3_vstripe(G),
    gridrun_stripe_colors_v(G, Colors),
    Colors = [r,b,g].
...
% Column 1 of g4x3_vstripe = [b,b,b,b]: runs [b-4].
    g4x3_vstripe(G),
    gridrun_col_runs(G, 1, Runs),
    Runs = [b-4].

test(col_runs_mixed) :-
% Column 2 of g4x4_mixed = [b,b,r,r]: runs [b-2,r-2].
    g4x4_mixed(G),
    gridrun_col_runs(G, 2, Runs),
    Runs = [b-2, r-2].
