% State the fact: name(a2a).
name(a2a).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Agent Interoperability — A2A protocol and durable agent mail (PR 43)').
title('PrologAI Agent Interoperability — A2A protocol and durable agent mail (PR 43)').
