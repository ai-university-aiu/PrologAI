...
% gsn_scan_row(+Grid, +R, +BgColor, -CVPairs)
...
% gsn_scan_col(+Grid, +C, +BgColor, -RVPairs)
...
% gsn_first_right(+Grid, +R, +C0, +BgColor, -C-V)
...
% gsn_first_left(+Grid, +R, +C0, +BgColor, -C-V)
...
% gsn_first_down(+Grid, +R0, +C, +BgColor, -R-V)
...
% gsn_first_up(+Grid, +R0, +C, +BgColor, -R-V)
...
% gsn_dist_right(+Grid, +R, +C0, +BgColor, -D)
...
gsn_dist_right(Grid, R, C0, BgColor, D) :-
    gsn_first_right(Grid, R, C0, BgColor, C-_),
    D is C - C0.

% gsn_dist_left(+Grid, +R, +C0, +BgColor, -D)
...
gsn_dist_left(Grid, R, C0, BgColor, D) :-
    gsn_first_left(Grid, R, C0, BgColor, C-_),
    D is C0 - C.

% gsn_dist_down(+Grid, +R0, +C, +BgColor, -D)
...
gsn_dist_down(Grid, R0, C, BgColor, D) :-
    gsn_first_down(Grid, R0, C, BgColor, R-_),
    D is R - R0.

% gsn_dist_up(+Grid, +R0, +C, +BgColor, -D)
