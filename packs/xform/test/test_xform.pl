...
% xf_recolor/3 tests.
test(recolor_basic) :-
    xf_recolor(obj(1, [r(0,0), r(0,1)]), 5, obj(5, [r(0,0), r(0,1)])).

test(recolor_single) :-
    xf_recolor(obj(3, [r(2,4)]), 0, obj(0, [r(2,4)])).

test(recolor_same) :-
    xf_recolor(obj(7, [r(0,0), r(1,1)]), 7, obj(7, [r(0,0), r(1,1)])).

% xf_translate/3 tests.
test(translate_right) :-
    xf_translate(obj(1, [r(0,0), r(0,1)]), r(0,3), Out),
    Out = obj(1, [r(0,3), r(0,4)]).

test(translate_down) :-
    xf_translate(obj(2, [r(0,0)]), r(2,0), Out),
    Out = obj(2, [r(2,0)]).

test(translate_diagonal) :-
    xf_translate(obj(3, [r(1,1), r(1,2), r(2,1)]), r(2,3), Out),
    Out = obj(3, [r(3,4), r(3,5), r(4,4)]).

% xf_normalize/2 tests.
test(normalize_at_origin) :-
    xf_normalize(obj(1, [r(0,0), r(0,1)]), Out),
    Out = obj(1, [r(0,0), r(0,1)]).

test(normalize_offset) :-
    xf_normalize(obj(2, [r(3,4), r(3,5), r(4,4)]), Out),
    Out = obj(2, [r(0,0), r(0,1), r(1,0)]).

test(normalize_single) :-
    xf_normalize(obj(5, [r(7,3)]), Out),
    Out = obj(5, [r(0,0)]).

% xf_d4/3 tests.
test(d4_id) :-
    xf_d4(obj(1, [r(0,0), r(0,1)]), id, Out),
    Out = obj(1, [r(0,0), r(0,1)]).

test(d4_r90_hpair) :-
    % horizontal pair at r(0,0), r(0,1): r90 -> vertical pair at same top-left
    xf_d4(obj(1, [r(0,0), r(0,1)]), r90, Out),
...
test(d4_fh) :-
    ...
    xf_d4(obj(2, [r(0,0), r(1,0), r(1,1)]), fh, Out),
    Out = obj(2, [r(0,1), r(1,0), r(1,1)]).

% xf_same_cells/2 tests.
test(same_cells_basic) :-
    xf_same_cells(obj(1, [r(0,0), r(0,1)]), obj(5, [r(0,0), r(0,1)])).

test(same_cells_single) :-
    xf_same_cells(obj(3, [r(2,3)]), obj(7, [r(2,3)])).

test(same_cells_fail, [fail]) :-
    xf_same_cells(obj(1, [r(0,0)]), obj(2, [r(0,1)])).

% xf_cell_offset/3 tests.
test(cell_offset_right) :-
    xf_cell_offset(obj(1, [r(0,0), r(0,1)]), obj(1, [r(0,3), r(0,4)]), Off),
    Off = r(0,3).

test(cell_offset_down) :-
    xf_cell_offset(obj(2, [r(1,1)]), obj(2, [r(4,1)]), Off),
    Off = r(3,0).

test(cell_offset_diagonal) :-
    xf_cell_offset(obj(1, [r(0,0), r(1,0)]), obj(1, [r(2,3), r(3,3)]), Off),
    Off = r(2,3).

% xf_is_recolor/2 tests.
test(is_recolor_basic) :-
    xf_is_recolor(obj(1, [r(0,0), r(0,1)]), obj(5, [r(0,0), r(0,1)])).

test(is_recolor_single) :-
    xf_is_recolor(obj(3, [r(2,3)]), obj(7, [r(2,3)])).

test(is_recolor_fail_same_color, [fail]) :-
    xf_is_recolor(obj(4, [r(0,0)]), obj(4, [r(0,0)])).

% xf_cells_added/3 tests.
test(cells_added_basic) :-
    Obj1 = obj(1, [r(0,0), r(0,1)]),
    Obj2 = obj(1, [r(0,0), r(0,1), r(0,2)]),
    xf_cells_added(Obj1, Obj2, Added),
    Added = [r(0,2)].
...
test(overlap_zero) :-
    xf_overlap_count(obj(1, [r(0,0)]), obj(2, [r(1,1)]), N),
    N = 0.
...
% xf_any_d4/3 tests.
test(any_d4_id) :-
    xf_any_d4(obj(1, [r(0,0), r(0,1)]), obj(2, [r(0,0), r(0,1)]), Op),
    Op = id.

test(any_d4_r90) :-
    % horizontal pair [r(0,0),r(0,1)] -> vertical pair [r(0,0),r(1,0)] via r90
    xf_any_d4(obj(1, [r(0,0), r(0,1)]), obj(2, [r(0,0), r(1,0)]), Op),
    Op = r90.

test(any_d4_fv) :-
    % L-shape [r(0,0),r(1,0),r(1,1)]: fv -> (H1-R,C): r(0,0)->(1,0), r(1,0)->(0,0), r(1,1)->(0,1)
    % sorted: [r(0,0),r(0,1),r(1,0)]
    xf_any_d4(obj(1, [r(0,0), r(1,0), r(1,1)]),
              obj(2, [r(0,0), r(0,1), r(1,0)]), Op),
    memberchk(Op, [r90, fv]).

% xf_scale_factor/3 tests.
test(scale_2x) :-
    Obj1 = obj(1, [r(0,0), r(0,1)]),
    Obj2 = obj(1, [r(0,0), r(0,1), r(0,2), r(0,3)]),
    xf_scale_factor(Obj1, Obj2, N),
    N = 2.

test(scale_1x) :-
    xf_scale_factor(obj(1, [r(0,0), r(1,0)]), obj(2, [r(0,0), r(0,1)]), N),
    N = 1.

test(scale_fail, [fail]) :-
    xf_scale_factor(obj(1, [r(0,0), r(0,1)]), obj(2, [r(0,0), r(0,1), r(0,2)]), _).

% xf_merge/3 tests.
test(merge_basic) :-
    Obj1 = obj(3, [r(0,0), r(0,1)]),
    Obj2 = obj(3, [r(1,0), r(1,1)]),
    xf_merge(Obj1, Obj2, Out),
...
test(merge_single) :-
    xf_merge(obj(5, [r(0,0)]), obj(5, [r(1,1)]), Out),
