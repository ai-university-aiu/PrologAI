:- module(grid_scan, [
    grid_scan_scan_row/4,
    grid_scan_scan_col/4,
    grid_scan_first_right/5,
    grid_scan_first_left/5,
    grid_scan_first_down/5,
    grid_scan_first_up/5,
    grid_scan_dist_right/5,
    grid_scan_dist_left/5,
    grid_scan_dist_down/5,
    grid_scan_dist_up/5,
    grid_scan_blocked_right/4,
    grid_scan_blocked_left/4,
    grid_scan_blocked_down/4,
    grid_scan_blocked_up/4
]).
...
% grid_scan_scan_row(+Grid, +R, +BgColor, -CVPairs)
...
% grid_scan_scan_col(+Grid, +C, +BgColor, -RVPairs)
...
% grid_scan_first_right(+Grid, +R, +C0, +BgColor, -C-V)
...
% grid_scan_first_left(+Grid, +R, +C0, +BgColor, -C-V)
...
% grid_scan_first_down(+Grid, +R0, +C, +BgColor, -R-V)
...
% grid_scan_first_up(+Grid, +R0, +C, +BgColor, -R-V)
...
% grid_scan_dist_right(+Grid, +R, +C0, +BgColor, -D)
...
grid_scan_dist_right(Grid, R, C0, BgColor, D) :-
    grid_scan_first_right(Grid, R, C0, BgColor, C-_),
    D is C - C0.

% grid_scan_dist_left(+Grid, +R, +C0, +BgColor, -D)
...
grid_scan_dist_left(Grid, R, C0, BgColor, D) :-
    grid_scan_first_left(Grid, R, C0, BgColor, C-_),
    D is C0 - C.

% grid_scan_dist_down(+Grid, +R0, +C, +BgColor, -D)
...
grid_scan_dist_down(Grid, R0, C, BgColor, D) :-
    grid_scan_first_down(Grid, R0, C, BgColor, R-_),
    D is R - R0.

% grid_scan_dist_up(+Grid, +R0, +C, +BgColor, -D)
...
grid_scan_dist_up(Grid, R0, C, BgColor, D) :-
    grid_scan_first_up(Grid, R0, C, BgColor, R-_),
    D is R0 - R.

% grid_scan_blocked_right(+Grid, +R, +C0, +BgColor)
% Succeeds if there is at least one non-BgColor cell in row R to the right of C0.
grid_scan_blocked_right(Grid, R, C0, BgColor) :-
    grid_scan_first_right(Grid, R, C0, BgColor, _).

% grid_scan_blocked_left(+Grid, +R, +C0, +BgColor)
% Succeeds if there is at least one non-BgColor cell in row R to the left of C0.
grid_scan_blocked_left(Grid, R, C0, BgColor) :-
    grid_scan_first_left(Grid, R, C0, BgColor, _).

% grid_scan_blocked_down(+Grid, +R0, +C, +BgColor)
% Succeeds if there is at least one non-BgColor cell in column C below row R0.
grid_scan_blocked_down(Grid, R0, C, BgColor) :-
    grid_scan_first_down(Grid, R0, C, BgColor, _).

% grid_scan_blocked_up(+Grid, +R0, +C, +BgColor)
% Succeeds if there is at least one non-BgColor cell in column C above row R0.
grid_scan_blocked_up(Grid, R0, C, BgColor) :-
    grid_scan_first_up(Grid, R0, C, BgColor, _).
