:- module(gridpos, [
    gridpos_top_half/2,
    gridpos_bottom_half/2,
    gridpos_left_half/2,
    gridpos_right_half/2,
    gridpos_quadrant/3,
    gridpos_even_rows/2,
    gridpos_odd_rows/2,
    gridpos_even_cols/2,
    gridpos_odd_cols/2,
    gridpos_checkerboard/3,
    gridpos_center_cell/3,
    gridpos_corners/2,
    gridpos_cross_h/3,
    gridpos_cross_v/3
]).
...
gridpos_subgrid_(Grid, R0, R1, C0, C1, Sub) :-
...
gridpos_row_parity_(Row, Parity, SubRow) :-
...
% gridpos_bottom_half(+Grid, -BotGrid)
...
% gridpos_quadrant(+Grid, +Quad, -SubGrid)
...
% Handle degenerate ranges (empty row or col span).
    (R0 > R1 -> SubGrid = [] ;
     ...
     ;
        gridpos_subgrid_(Grid, R0, R1, C0, C1, SubGrid)).

% gridpos_even_rows(+Grid, -EvenGrid)
