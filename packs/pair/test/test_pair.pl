...
% pair_obj_shape/2 tests.
test(shape_single) :-
    pair_obj_shape(obj(1, [r(0,0)]), Shape),
    Shape = [r(0,0)].

test(shape_hpair) :-
    pair_obj_shape(obj(2, [r(0,0), r(0,1)]), Shape),
    Shape = [r(0,0), r(0,1)].

test(shape_vpair_eq_hpair) :-
    pair_obj_shape(obj(3, [r(0,0), r(1,0)]), Shape),
    Shape = [r(0,0), r(0,1)].

% pair_obj_color/2 tests.
test(color_5) :-
    pair_obj_color(obj(5, [r(0,0)]), 5).

test(color_0) :-
    pair_obj_color(obj(0, [r(1,2)]), 0).

test(color_9) :-
    pair_obj_color(obj(9, [r(0,0), r(0,1), r(0,2)]), 9).

% pair_obj_size/2 tests.
test(size_one) :-
    pair_obj_size(obj(1, [r(0,0)]), N),
    N = 1.

test(size_three) :-
    pair_obj_size(obj(2, [r(0,0), r(0,1), r(0,2)]), N),
    N = 3.

test(size_four) :-
    pair_obj_size(obj(3, [r(0,0), r(0,1), r(1,0), r(1,1)]), N),
    N = 4.

% pair_shape_eq/2 tests.
...
% pair_color_eq/2 tests.
test(color_eq_basic) :-
    pair_color_eq(obj(3, [r(0,0)]), obj(3, [r(1,2)])).

test(color_eq_different_sizes) :-
    pair_color_eq(obj(7, [r(0,0), r(0,1)]), obj(7, [r(0,0)])).

test(color_eq_zero) :-
    pair_color_eq(obj(0, [r(0,0)]), obj(0, [r(2,3), r(3,4)])).

% pair_size_eq/2 tests.
test(size_eq_single) :-
    pair_size_eq(obj(1, [r(0,0)]), obj(2, [r(5,5)])).
...
test(group_color_single) :-
    pair_group_color([obj(3,[r(0,0)])], Groups),
...
test(match_color_no_match) :-
    pair_match_color([obj(1,[r(0,0)])], [obj(2,[r(0,0)])], Pairs),
    Pairs = [].

% pair_match_size/3 tests.
...
test(match_size_no_match) :-
    pair_match_size([obj(1,[r(0,0)])], [obj(2,[r(0,0),r(0,1)])], Pairs),
    Pairs = [].

% pair_match_shape/3 tests.
...
test(match_shape_no_match) :-
    pair_match_shape([obj(1,[r(0,0)])], [obj(2,[r(0,0),r(0,1)])], Pairs),
    Pairs = [].
