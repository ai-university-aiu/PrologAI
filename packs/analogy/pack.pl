% State the fact: name(analogy).
name(analogy).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Analogy — ARC-AGI structural analogy and transformation inference (PR 57)').
title('PrologAI Analogy — ARC-AGI structural analogy and transformation inference (PR 57)').
