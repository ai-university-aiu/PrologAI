...
test(neighbors4_interior) :-
    ...
    wn_neighbors4(Grid, 1, 1, Ns),
    length(Ns, 4).

test(neighbors4_corner) :-
    Grid = [[1,2],[3,4]],
    wn_neighbors4(Grid, 0, 0, Ns),
    length(Ns, 2).
...
test(neighbors8_interior) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_neighbors8(Grid, 1, 1, Ns),
    length(Ns, 8).

test(neighbors8_corner) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_neighbors8(Grid, 0, 0, Ns),
    length(Ns, 3).

test(neighbors8_edge) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_neighbors8(Grid, 0, 1, Ns),
    length(Ns, 5).
...
test(count8_basic) :-
    ...
    wn_count8(Grid, 1, 1, 1, N),
    N = 8.

test(count8_zero) :-
    Grid = [[0,0,0],[0,1,0],[0,0,0]],
    wn_count8(Grid, 1, 1, 0, N),
    N = 8.

test(count8_corner) :-
    Grid = [[1,1],[1,1]],
    wn_count8(Grid, 0, 0, 1, N),
    N = 3.
...
test(extract_basic) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_extract(Grid, 0, 0, 2, 2, Sub),
    Sub = [[1,2],[4,5]].

test(extract_center) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_extract(Grid, 1, 1, 2, 2, Sub),
    Sub = [[5,6],[8,9]].

test(extract_row) :-
    Grid = [[1,2,3],[4,5,6]],
    wn_extract(Grid, 0, 1, 1, 2, Sub),
    Sub = [[2,3]].
...
test(slide_count) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_slide(Grid, 2, 2, Ws),
    length(Ws, 4).

test(slide_too_large) :-
    Grid = [[1,2],[3,4]],
    wn_slide(Grid, 3, 3, Ws),
    Ws = [].

test(slide_first_window) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_slide(Grid, 2, 2, [W|_]),
    W = 0-0-[[1,2],[4,5]].
...
test(local_max4_true) :-
    ...
    wn_local_max4(Grid, 1, 1).

test(local_max4_false) :-
    Grid = [[1,2,1],[2,3,2],[1,2,1]],
    \+ wn_local_max4(Grid, 0, 1).

test(local_max4_corner) :-
    Grid = [[5,1],[1,1]],
    wn_local_max4(Grid, 0, 0).
...
test(manhattan_zero) :-
    wn_manhattan(1, 1, 1, 1, D),
    D = 0.

test(manhattan_negative_delta) :-
    wn_manhattan(3, 3, 1, 1, D),
    D = 4.
...
test(cells_at_dist_basic) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_cells_at_dist(Grid, 1, 1, 1, Cells),
    sort(Cells, Sorted),
    Sorted = [0-1, 1-0, 1-2, 2-1].

test(cells_at_dist_zero) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_cells_at_dist(Grid, 1, 1, 0, Cells),
    Cells = [1-1].

test(cells_at_dist_boundary) :-
    Grid = [[1,2,3],[4,5,6],[7,8,9]],
    wn_cells_at_dist(Grid, 0, 0, 2, Cells),
    sort(Cells, Sorted),
    Sorted = [0-2, 1-1, 2-0].
