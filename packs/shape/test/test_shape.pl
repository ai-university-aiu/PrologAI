...
test(l_from_grid) :-
    l_grid(G),
    shape_from_grid(G, 1, Shape),
    Shape = [r(0,0), r(1,0), r(2,0), r(2,1)].

test(diag_from_grid) :-
    diag_grid(G),
    shape_from_grid(G, 2, Shape),
    Shape = [r(0,0), r(1,1), r(2,2)].

test(absent_color_fails, [fail]) :-
    l_grid(G),
    shape_from_grid(G, 9, _Shape).
...
test(contains_yes) :-
    l_grid(G),
    shape_from_grid(G, 1, Shape),
    shape_contains_cell(Shape, r(0,0)).

test(contains_corner) :-
    l_grid(G),
    shape_from_grid(G, 1, Shape),
    shape_contains_cell(Shape, r(2,1)).

test(contains_no, [fail]) :-
    l_grid(G),
    shape_from_grid(G, 1, Shape),
    shape_contains_cell(Shape, r(0,1)).
...
test(equal_same) :-
    shape_from_cells([r(0,0), r(0,1), r(1,0)], Shape),
    shape_equal(Shape, Shape).

test(equal_two_copies) :-
    shape_from_cells([r(0,0), r(0,1)], S1),
    shape_from_cells([r(3,5), r(3,6)], S2),
    shape_equal(S1, S2).

test(equal_fails, [fail]) :-
    shape_from_cells([r(0,0), r(0,1)], S1),
    shape_from_cells([r(0,0), r(1,0)], S2),
    shape_equal(S1, S2).
...
test(translate_basic) :-
    shape_from_cells([r(0,0), r(0,1)], Shape),
    shape_translate(Shape, 2, 3, Shape2),
    Shape2 = [r(2,3), r(2,4)].

test(translate_zero) :-
    shape_from_cells([r(0,0), r(1,0)], Shape),
    shape_translate(Shape, 0, 0, Shape2),
    Shape2 = Shape.
...
test(rotate90_x4_identity) :-
    shape_from_cells([r(0,0), r(0,1), r(1,0)], Shape),
    shape_rotate90(Shape, R1),
    shape_rotate90(R1, R2),
    shape_rotate90(R2, R3),
    shape_rotate90(R3, R4),
    shape_equal(Shape, R4).
...
test(reflect_h_twice_identity) :-
    shape_from_cells([r(0,0), r(0,1), r(1,0)], Shape),
    shape_reflect_h(Shape, R1),
    shape_reflect_h(R1, R2),
    shape_equal(Shape, R2).
...
test(reflect_v_bar) :-
    ...
    shape_from_cells([r(0,0), r(1,0), r(2,0)], Shape),
...
test(reflect_v_twice_identity) :-
    shape_from_cells([r(0,0), r(0,1), r(1,0)], Shape),
    shape_reflect_v(Shape, R1),
    shape_reflect_v(R1, R2),
    shape_equal(Shape, R2).
...
test(canonical_same_for_rotations, [nondet]) :-
    shape_from_cells([r(0,0), r(1,0), r(2,0), r(2,1)], Shape),
    shape_rotate90(Shape, R90),
    shape_canonical(Shape, C1),
    shape_canonical(R90, C2),
    shape_equal(C1, C2).
...
test(canonical_same_for_reflections, [nondet]) :-
    ...
    shape_canonical(Shape, C1),
    shape_canonical(HFlip, C2),
    shape_equal(C1, C2).

test(canonical_different_shapes, [fail]) :-
    shape_from_cells([r(0,0), r(0,1), r(0,2)], Bar),
    shape_from_cells([r(0,0), r(1,0), r(2,0), r(2,1)], L),
    shape_canonical(Bar, C1),
    shape_canonical(L, C2),
    shape_equal(C1, C2).
...
test(equivalent_rotation, [nondet]) :-
    shape_from_cells([r(0,0), r(1,0), r(2,0), r(2,1)], Shape),
    shape_rotate90(Shape, R90),
    shape_equivalent(Shape, R90).

test(equivalent_reflection, [nondet]) :-
    shape_from_cells([r(0,0), r(1,0), r(2,0), r(2,1)], Shape),
    shape_reflect_v(Shape, VFlip),
    shape_equivalent(Shape, VFlip).

test(equivalent_different, [fail]) :-
    shape_from_cells([r(0,0), r(0,1), r(0,2)], Bar),
    shape_from_cells([r(0,0), r(1,0), r(2,0), r(2,1)], L),
    shape_equivalent(Bar, L).
