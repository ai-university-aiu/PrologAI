% State the fact: this pack is named co_lore.
name(co_lore).
% State the fact: this is version 1.0.0.
version('1.0.0').
% State the fact: the title carries the work-package number.
title('PrologAI Causalontology Lore — turn repeated experience into advice: detect recurring themes ("this keeps happening"), recall the lessons of matching past situations, and distil a maxim of what to do or avoid (WP-424)').
