...
% From (0,0) in g3x3, the nearest b is at center (1,1).
    g3x3(G),
    gd_nearest_coord(G, 0, 0, b, Coord),
    Coord = [1, 1].
...
% g3x3: b at (1,1) has dist 1 from nearest r. Palette=[yellow] -> becomes yellow.
    g3x3(G),
    gd_recolor_by_dist(G, b, [yellow], NewG),
    nth0(1, NewG, Row),
    nth0(1, Row, V),
    V = yellow.
