% State the fact: name(sentinels).
name(sentinels).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Sentinels — Neuro-Symbolic Opportunistic Forward Chaining (PR 9 bootstrap)').
title('PrologAI Sentinels — Neuro-Symbolic Opportunistic Forward Chaining (PR 9 bootstrap)').
