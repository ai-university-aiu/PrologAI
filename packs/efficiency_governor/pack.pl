% State the fact: name(efficiency_governor).
name(efficiency_governor).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Causalontology Efficiency Governor — action budgeting and RHAE-style efficiency scoring against a human baseline for ARC-AGI-3 (WP-399)').
title('PrologAI Causalontology Efficiency Governor — action budgeting and RHAE-style efficiency scoring against a human baseline for ARC-AGI-3 (WP-399)').
