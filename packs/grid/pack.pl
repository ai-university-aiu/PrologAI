% State the fact: name(grid).
name(grid).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Grid — ARC-AGI grid perception and manipulation (PR 56)').
title('PrologAI Grid — ARC-AGI grid perception and manipulation (PR 56)').
