% State the fact: name(tom).
name(tom).
% State the fact: version('1.0.0').
version('1.0.0').
% State the fact: title('PrologAI Theory of Mind — nested beliefs, false-belief reasoning, perspective taking, and BDI attribution (WP-389)').
title('PrologAI Theory of Mind — nested beliefs, false-belief reasoning, perspective taking, and BDI attribution (WP-389)').
