% State the fact: this pack is named co_salience.
name(co_salience).
% State the fact: this is version 1.0.0.
version('1.0.0').
% State the fact: the title carries the work-package number.
title('PrologAI Causalontology Attention & Broadcast — score candidate items by novelty, goal-relevance, and affect, keep a bounded working set, and broadcast one winner per cognitive cycle (WP-410)').
