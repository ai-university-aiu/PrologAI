...
| `co_explore` | Causalontology Exploration Policy — novelty-seeking, loop-avoiding action selection for interactive environments: a canonical order-free state signature that recognises a returned-to state, a preference for actions the causal graph predicts will change the world, curiosity by least-tried, and salient click targeting that turns the ACTION6 cell-select into a handful of object-centroid clicks rather than 4096 blind cells (co_*, Layer 372) (WP-397) |
