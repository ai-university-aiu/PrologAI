...
| [PrologAI Requirements Ledger](docs/PrologAI_Requirements_Ledger_v3.txt) | The consolidated program-wide Ledger — every Connectome finding (open gaps, closed track record, cross-cutting patterns, and the forward agenda) gathered into one canonical view |
