...
|---|---|---|
| 1 | `PrologAI_1_Specification_v246` | Authoritative statement of what to build |
| 2 | `PrologAI_2_Pseudocode_v238` | How each work package reasons |
| 3 | `PrologAI_3_Architecture_v241` | Where each piece lives |
| 4 | `PrologAI_4_Refinement_v298` | Testing protocols and safety criteria |
| 5 | `PrologAI_5_Completion_v304` | Release criteria and completion evidence |
...
It runs 48 reasoning types, achieved a confirmed perfect score of 400/400 = 100% on ARC-AGI-1 (Abstract Reasoning Corpus - Artificial General Intelligence - Year 1), and is actively climbing ARC-AGI-2 (current score: 17/120 = 14.17%, Wave 17 complete).
