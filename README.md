...
| `arc3_protocol` | ARC-AGI-3 Protocol — the exact March-2026 agents-API vocabulary as inspectable facts: the ACTION1-ACTION7 and RESET commands under /api/cmd, the cell-select ACTION6 with x,y, scorecard open and close, the four game states with WIN and GAME_OVER terminal, 64×64 frames of colours 0-15, and a guarded arc3_protocol_env adapter that packages the live protocol as a co_arc3 environment (co_*, Layer 375) (WP-400) |
