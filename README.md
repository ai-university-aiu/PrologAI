...
```
PrologAI/
├── packs/       216 work packages — the complete cognitive engine (see below)
...
|---|---|---|
| 1 | `PrologAI_1_Specification_v181` | Authoritative statement of what to build |
| 2 | `PrologAI_2_Pseudocode_v174` | How each work package reasons |
| 3 | `PrologAI_3_Architecture_v175` | Where each piece lives |
| 4 | `PrologAI_4_Refinement_v229` | Testing protocols and safety criteria |
| 5 | `PrologAI_5_Completion_v232` | Release criteria and completion evidence |
