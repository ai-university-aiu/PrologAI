...
```
PrologAI/
├── packs/       262 work packages — the complete cognitive engine (see below)
...
Layer 60 and above is the Data Layer: the 200 perception, analysis, and transformation packs that handle structured data, currently reaching Layer 241 (gridresize).
...
|---|---|---|
| 1 | `PrologAI_1_Specification_v228` | Authoritative statement of what to build |
| 2 | `PrologAI_2_Pseudocode_v220` | How each work package reasons |
| 3 | `PrologAI_3_Architecture_v222` | Where each piece lives |
| 4 | `PrologAI_4_Refinement_v275` | Testing protocols and safety criteria |
| 5 | `PrologAI_5_Completion_v278` | Release criteria and completion evidence |
