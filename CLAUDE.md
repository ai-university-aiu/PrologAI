...
The Specification (docs/PrologAI_1_Specification_Final_v6.txt) is authoritative for what to build, 

the Pseudocode (docs/PrologAI_2_Pseudocode_Final_v4.txt) for how each work package reasons, 

the Architecture (docs/PrologAI_3_Architecture_Final_v4.txt) for where each piece lives, 

the Refinement (docs/PrologAI_4_Refinement_Final_v4.txt) for testing and safety, 

and the Completion (docs/PrologAI_5_Completion_Final_v4.txt) for release.
