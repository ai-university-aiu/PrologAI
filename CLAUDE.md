...
The Specification (docs/PrologAI_1_Specification_v255.txt) is authoritative for what to build,

the Pseudocode (docs/PrologAI_2_Pseudocode_v247.txt) for how each work package reasons,

the Architecture (docs/PrologAI_3_Architecture_v248.txt) for where each piece lives,

the Refinement (docs/PrologAI_4_Refinement_v307.txt) for testing and safety,

the Completion (docs/PrologAI_5_Completion_v313.txt) for release,
