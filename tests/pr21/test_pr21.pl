...
:- use_module(library(budget),     [pai_budget/3, pai_budget_set/4,
                                    % Supply 'pai_budget_get/4' as the next argument to the expression above.
                                    pai_budget_get/4,
                                    % Supply 'pai_truth_evidence/3' as the next argument to the expression above.
                                    pai_truth_evidence/3,
                                    % Supply 'pai_truth_evidence_add/3' as the next argument to the expression above.
                                    pai_truth_evidence_add/3,
                                    % Supply 'pai_best_answer/2' as the next argument to the expression above.
                                    pai_best_answer/2,
                                    % Supply 'pai_revise/3' as the next argument to the expression above.
                                    pai_revise/3,
                                    % Supply 'pai_budget_decay/1' as the next argument to the expression above.
                                    pai_budget_decay/1,
